...
task_parameters.update({
    "task_name": "2DIR1O",
    "input_direction_units": 240,  # how many direction-selective input units?
    "dim_input": 240 + 1,  # plus one input for go cue signal
})
...
class Model(Model):
    def __init__(self):
        ...
        self.top_parameters = nn.Parameter(torch.tensor([3, -0.5, -0.5])/240*10)
