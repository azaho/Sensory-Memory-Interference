...
hyperparameters.update({
    "random_string": str("TTXX2"),  # human-readable string used for random initialization (for reproducibility)

    "train_for_steps": 2000,  # 5000
    "learning_rate": 1e-3,
})
...
class Model(Model):
    def __init__(self):
        ...
        # 4: as conn
        self.top_parameters = nn.Parameter(torch.tensor([3, -0.5, -0.5, -1])/100*10)
