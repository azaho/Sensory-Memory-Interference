...
hyperparameters.update({
    "random_string": str("BEH_60_1"),  # human-readable string used for random initialization (for reproducibility)

    "train_for_steps": 5000,  # 5000
    "learning_rate": 1e-3,
})
...
class Model(Model):
    def __init__(self):
        ...
        self.top_parameters = nn.Parameter(torch.tensor([3, -0.5, -0.5])/100*10)
