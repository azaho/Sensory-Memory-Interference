...
hyperparameters.update({
    "random_string": str("TEST_CORRELATIONS"),  # human-readable string used for random initialization (for reproducibility)
    "train_for_steps": 100
})
...
class Model(Model):
    def __init__(self):
        ...
        # 2: R1 bias
        self.top_parameters = nn.Parameter(torch.tensor([2/1**0.5, -1])/100*10)
